...
main(int argc,char *argv[])
{
  ...
  4d:	50                   	push   %eax
  4e:	56                   	push   %esi
  4f:	68 68 07 00 00       	push   $0x768
  54:	6a 01                	push   $0x1
  56:	e8 c5 03 00 00       	call   420 <printf>
	chdl(pid,deadline);
  5b:	58                   	pop    %eax
  5c:	5a                   	pop    %edx
  5d:	53                   	push   %ebx
  5e:	56                   	push   %esi
  5f:	e8 0e 03 00 00       	call   372 <chdl>
	exit();
  ...
  69:	51                   	push   %ecx
  6a:	51                   	push   %ecx
  6b:	68 56 07 00 00       	push   $0x756
  70:	6a 02                	push   $0x2
  72:	e8 a9 03 00 00       	call   420 <printf>
    exit();
  77:	e8 46 02 00 00       	call   2c2 <exit>
  7c:	66 90                	xchg   %ax,%ax
  7e:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 88 07 00 00 	movzbl 0x788(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 538:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 53b:	b8 80 07 00 00       	mov    $0x780,%eax
...
free(void *ap)
{
 ...
 617:	89 08                	mov    %ecx,(%eax)
  freep = p;
 619:	a3 28 0a 00 00       	mov    %eax,0xa28
}
 61e:	5b                   	pop    %ebx
 61f:	5e                   	pop    %esi
 620:	5f                   	pop    %edi
 ...
 63a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 63d:	a3 28 0a 00 00       	mov    %eax,0xa28
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 28 0a 00 00    	mov    0xa28,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6fc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6ff:	89 15 28 0a 00 00    	mov    %edx,0xa28
      return (void*)(p + 1);
 ...
 714:	eb e9                	jmp    6ff <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 716:	c7 05 28 0a 00 00 2c 	movl   $0xa2c,0xa28
 71d:	0a 00 00 
 720:	c7 05 2c 0a 00 00 2c 	movl   $0xa2c,0xa2c
 727:	0a 00 00 
    base.s.size = 0;
 72a:	b8 2c 0a 00 00       	mov    $0xa2c,%eax
